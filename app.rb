...
puts "Estimated yearly revenue: #{average_yearly_revenue.round} | Estimated invested budget: #{average_invested_budget.round} | Estimated net revenue: #{average_net_revenue.round} | Estimated rider churn count: #{average_rider_churn_count.round}"
